...
//        Graph<Integer> graph = new Graph<Integer>(N,subs);
//        int M = Integer.parseInt(bf.readLine());
//        for(int i=0;i<M;i++){
//            String[] line = bf.readLine().split("\\s+");
//            graph.addEdge(Integer.parseInt(line[0]),Integer.parseInt(line[2]), Integer.parseInt(line[4]));
//            names[Integer.parseInt(line[0])] = line[1];
//            names[Integer.parseInt(line[2])] = line[3];
//        }
//        int from = indexOf(names,bf.readLine());
//        System.out.println(graph.prim(from).stream().mapToInt(x -> (int) x.getWeight()).sum());
//
//
//    }
//}
