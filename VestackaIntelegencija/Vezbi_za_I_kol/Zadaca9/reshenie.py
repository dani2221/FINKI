...
class Squares(Problem):
    ...
    def successor(self, state):
        ...
        for kv in range(5):
            ...
            temp_list[kv] = (x, y + 1)
            if self.check_valid(temp_list):
                succ[f'Pomesti kvadratche {kv + 1} gore'] = tuple(temp_list)
            temp_list[kv] = (x, y - 1)
            if self.check_valid(temp_list):
                succ[f'Pomesti kvadratche {kv + 1} dolu'] = tuple(temp_list)
            temp_list[kv] = (x - 1, y)
            if self.check_valid(temp_list):
                succ[f'Pomesti kvadratche {kv + 1} levo'] = tuple(temp_list)
            temp_list[kv] = (x + 1, y)
            if self.check_valid(temp_list):
                succ[f'Pomesti kvadratche {kv + 1} desno'] = tuple(temp_list)
