...
if __name__ == '__main__':
    ...
    dataset = [[float(el) for el in item] for item in dataset]

    train = dataset[:math.ceil(len(dataset)*0.85)]
    test = dataset[math.ceil(len(dataset)*0.85):]
    ...
    entry = [float(item) for item in input().split(" ")]
    print(int(model.predict([entry])[0]))
